var contentData = [{
    ...
    sections: [{
        ...
        tags: "A dev",
        content: "Lehel peab olema võimalik teha kõiki tegevusi (välja arvatud nt joonistamine) kasutades <b>ainult hiirt</b> ja ka <b>ainult klaviatuuri</b> (<i>tab</i> klahvi või nooleklahve). Lehel ei tohi leiduda <b>klaviatuurilõkse</b> ehk olukordi, kus klaviatuuriga mingi funktsiooni juurde minna on võimalik, kuid sealt ära enam mitte."
    }, {
        tags: "O dev",
        ...
        tags: "O dev",
        content: "Päästiksündmustena tuleb vältida hiire allavajutust (<b>onmousedown</b>), lahtilaskmist (<b>onmouseup</b>), topeltklõpsu (<b>ondblclick</b>), kursori peale viimist (<b>onmouseover</b>) ja kursori eemaldamist (<b>onmouseout</b>), sest need pole juurdepääsetavad klaviatuuri ja tugitehnoloogiatega."
    }, {
        tags: "A dev",
        content: "Ettevaatlik tuleb olla <b>robotilõksude</b> kasutamises, sest CAPTCHA pildid on ekraanilugejaga loetamatud ning nupud ja lohistamisribad ei luba tihti turvakaalutlustel hiireklõpsu simuleerimist olles seega samuti ekraanilugejaga kasutamatud. Parem variant on robotilõksuna kasutada lihtsaid, kuid vastamisel inimlikku loogikat vajavaid küsimusi, näiteks 'Kas päike on kollane või sinine?'<br><div class='examples'><figure class='good'><img alt='Robotilõks küsib kasutajalt, kui palju on 2 + 2' src='img/logical.jpg'><figcaption>Kasutajalt küsitakse loogiline küsimus</figcaption></figure><figure class='bad'><img alt='Robotilõks palub kasutajal lohistada nupp ühest kohast teise' src='img/drag.jpg'><figcaption>Kasutajat sunnitakse lohistama</figcaption></figure></div>"
    }, {
        tags: "O dev",
        content: "Kerimist peaks lubama vaid ühes suunas (ülevalt-alla või vasakult-paremale). Erandiks on näiteks galeriid."
    }, {
        tags: "O dev",
        content: "Leht ei tohi ennast <b>automaatselt värskendada</b>, sest see võib kustutada kasutaja pooleli jäänud töö ning kasutada piiratud mobiilse interneti mahtu."
    }, {
        tags: "A dev",
        content: "Kui lehel on <b>ajalimiit</b> (lühem kui 20 tundi), peab kasutajat sellest hoiatama, lubama limiidi välja lülitamist või pikendamist (selleks peab andma vähemalt 20 sekundit aega)."
    }, {
        tags: "O dev",
        ...
        tags: "A dev",
        content: "Miski veebilehel ei tohi miski <b>sähvida</b> rohkem kui 3 korda sekundis, sest see võib tekitada haigushooge. Sähvimist peab saama välja lülitada."
    }, {
        tags: "A dev",
        ...
        tags: "A dev",
        content: "Märgistuskeeles kirjutatud kood peab valideeruma formaalseid validaatoreid (näiteks <a href='http://validator.w3.org' target='_blank'>W3 validaator</a>) kasutades"
    }]
}, {
    title: "Lehe andmed",
    sections: [{
        tags: "A dev",
        content: "Lehe keel peab olema märgitud ISO 639-1 koodiga <b>&lt;html&gt;</b> elemendi <b>lang=“…”</b> atribuudis, näiteks <b>&lt;html lang=”et”&gt;</b>."
    }, {
        tags: "A dev",
        content: "Igal lehel peal olema informatiivne ja lehte kirjeldav tiitel <b>&lt;title&gt;</b> märgendina.<br><pre>&lt;head&gt;<br>   &lt;title&gt;<br>      Kontakt - Firmanimi OÜ<br>   &lt;/title&gt;<br>&lt;/head&gt;</pre>"
    }, {
        tags: "O dev",
    ...
    sections: [{
        ...
        tags: "M des",
        content: "Navigatsioon peab lehele minnes kohe näha olema. Soovitatav on kasutada menüüd lehe ülaservas või vasakul. Mobiilsetel lehtedel võib kasutada lisaks ka kuni kuute kerimisel kaasaliikuvat kiirvalikut lehe allservas.<figure class='single'><img alt='Kiirvalikutega mobiilimenüü mobiili alumises servas' src='img/mobile-nav.png'><figcaption>Kiirvalikud mobiili alumises servas.</figcaption></figure>"
    }, {
        tags: "M des",
    ...
    sections: [{
        ...
        tags: "AA sis",
        content: "Pealkiri peab olema lühike, kuid sisukas ning kirjeldama sellele pealkirjale järgnevat sisu. Pealkiri peab algama kõige tähtsama ja sisukama sõnaga."
    }, {
        tags: "O dev",
    ...
    sections: [{
        ...
        tags: "AA dev",
        content: "Teksti suurused tuleb määrata rem ühikutes, et veebilehitseja seadetes teksti suurust muutes muutuks vastavalt ka veebilehe teksti suurused. Teksti (v.a subtiitreid) peab saama suurendada 200% ilma, et sisu ekraanilt kaoks või kattuks.<pre>p &#123;<br>   font-size: 1rem;<br>&#125;</pre>"
    }, {
        tags: "O dev",
        ...
        tags: "O dev",
        content: "Teksti peab olema võimalik korrektses järjekorras aktiveerida ning kopeerida."
    }, {
        tags: "AA dev",
        content: "Teksti asemel ei tohiks kasutada pilti, millel on tekst, sest seda ei saa kopeerida ega lugeda ekraanilugejaga. Erandiks on logod, millele tuleb lihtsalt lisada alt=”…”."
    }, {
        tags: "O des",
        ...
        tags: "AA dev",
        content: "Kui osa tekstist on lehe üldisest keelest erinevas keeles, peab see olema märgitud näiteks ISO 639-1 koodiga lang=“…” atribuudis.<pre>&lt;span lang='en'&gt;Hello&lt;/span&gt;</pre>"
    }]
}, {
    title: "Lingid",
    sections: [{
        ...
        tags: "A sis",
        content: "Lingi tekstist peab saama selgelt aru, mis sellele vajutades juhtub. Lingi tekst peaks algama kõige tähtsama ja sisukama sõnaga. Lingi tekst ei tohiks olla lihtsalt <b>“Kliki siia”</b> või <b>“Rohkem”</b> ega lihtsalt <b>URL</b>, sest ekraanilugeja loeb selle ette täht haaval. Lingi tekst ei tohiks sisaldada sõna <b>“link”</b>, sest ekraanilugejad ütlevad, et tegu on lingiga ning nägijate jaoks peavad lingid olema tekstist visuaalselt eristatavad."
    }, {
        tags: "O dev",
    ...
    sections: [{
        tags: "A des",
        content: "Elemendid ja nende olekud ei tohi olla eristatud ainult värviga. Info, mida antakse edasi värvidega, peab olema kättesaadav ka ilma värvideta.<br><div class='examples'><figure class='good'><img alt='Graafik sektoritega, kus iga sektori juures on silt' src='img/graafik_labels.png'><figcaption>Lisaks värvidele on ka sildid</figcaption></figure><figure class='bad'><img alt='Graafik sektoritega, mis on erinevat värvi' src='img/graafik.png'><figcaption>Sektorid on eristatavad ainult värviga</figcaption></figure></div>"
    }, {
        tags: "AA des",
        content: "<b>Fookuses olev element</b> peab olema selgelt visuaalselt eristatav, et klaviatuuriga navigeerijatel oleks selge, mille juures nad lehel asuvad.<figure><img alt='Menüü, milles üks element on fokuseeritud' class='single' src='img/menu_focus.jpg'></figure>"
    }, {
        tags: "A des",
    ...
    sections: [{
        tags: "A dev",
        content: "Igal pildil peab olema märgitud tekstiline alternatiiv <b>alt=“…”</b> atribuudiga. Tekstiline alternatiiv peab kandma edasi sama informatsiooni kui pilt ise. Tekstiline alternatiiv ei tohi olla lihtsalt <b>“Pilt”</b> või <b>“Tabel”</b>. Tekstilisse alternatiivi pole vaja kirjutada <b>“Pildi peal on…”</b>, sest ekraanilugeja ütleb, et tegu on pildiga.<pre>&lt;img alt=“Tallinna Tehnikaülikooli logo” src=“tty.jpg”&gt;</pre><div class='examples'><figure class='good'><img alt='Uudiste lehel on päikese pilt, mille tekstiline alternatiiv ütleb Selge ilm' src='img/alt.png'><figcaption>Tekstiline alternatiiv annab edasi sama infot, mis pilt.</figcaption></figure><figure class='bad'><img alt='Pildil pole tekstilist alternatiivi' src='img/No_alt.png'><figcaption>Info läheb kaduma.</figcaption></figure></div>"
    }, {
        tags: "O dev",
    ...
    sections: [{
        tags: "A dev",
        content: "Heli, videot ja animatsiooni (mis kestab kauem kui 5 sekundit) peab saama <b>katkestada</b>, <b>kinni panna</b> ning <b>heli tugevust muuta</b>."
    }, {
        tags: "A dev",
        content: "Veebilehel olevale helile ja videole peab lisama kirjeldava <b>title=”...”</b> atribuudi."
    }, {
        tags: "A dev",
        content: "<b>Eellindistatud</b> videofailile tuleb lisada <b>sünkroonsed subtiitrid ja helikirjeldused</b> (näiteks <b>[rahulik muusika]</b>), kui kogu edastatav info pole lehelt teisiti kättesaadav."
    }, {
        tags: "AA dev",
        content: "<b>Reaalajas</b> edastatavale videofailile tuleb lisada <b>sünkroonsed subtiitrid ja helikirjeldused</b> (näiteks <b>[rahulik muusika]</b>), kui kogu edastatav info pole lehelt teisiti kättesaadav."
    }, {
        tags: "A dev",
        content: "Eellindistatud heli- ja videofailidele tuleb lisada <b>tekstiline sisukirjeldus</b>, mis asub või millele viidatakse faili vahetus läheduses. Näiteks võib videole lisada tekstilise kirjelduse <b>&lt;track&gt;</b> märgendiga <b>&lt;video&gt;</b> märgendi sees. Ilma helita videole võib tekstiline alternatiivi asemel lisada sama sisu edasi andva <b>helifaili</b>.<pre>&lt;video controls&gt;<br>   &lt;source src=“video.mp4” srclang=“et” type=“video/mp4”&gt;<br>   &lt;track src=“description.vtt” kind=“descriptions” srclang=“et” label=“Video kirjeldus”&gt;<br>&lt;/video&gt;</pre>"
    }, {
        tags: "AA dev",
        content: "Eellindistatud videofailile tuleb lisada <b>heliline sisukirjeldus</b>, sest selle kuulamine on nägemispuudega kasutajatele mugavam."
    }]
}, {
    title: "Vormid",
    sections: [{
        ...
        tags: "AA dev",
        content: "Kui vormi ära saatmisel on õiguslikud või finantsilised tagajärjed, peab kasutajal olema võimalik sisestatud info üle vaadata ning vajadusel saatmine tagasi võtta."
    }, {
        tags: "O dev",
    ...
    sections: [{
        tags: "AA des",
        content: "Nupud peavad kogu lehe ulatuses olema sarnased ja äratuntavad."
    }, {
        tags: "M des",
